...
LEAN_EXPORT uint32_t l_simpleConst;
static lean_object* l_main___closed__2;
lean_object* lean_string_append(lean_object*, lean_object*);
static uint32_t _init_l_simpleConst() {
_start:
{
uint32_t x_1; 
x_1 = 42;
...
LEAN_EXPORT lean_object* initialize_simple(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
l_simpleConst = _init_l_simpleConst();
...
res = initialize_simple(1 /* builtin */, lean_io_mk_world());
