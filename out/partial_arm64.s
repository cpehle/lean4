...
_l_main___closed__0:
  ...
  .globl _l_main___lam__0___boxed
  .align 2
_l_main___lam__0___boxed:
  // Function: main._lam_0._boxed
  stp x29, x30, [sp, #-16]!
  mov x29, sp
...
_lean_main:
  ...
  mov x19, x0
  mov x27, #10
  // partial application main._lam_0._boxed with 1 args
  adrp x0, _l_main___lam__0___boxed@PAGE
  add x0, x0, _l_main___lam__0___boxed@PAGEOFF
  mov x1, #2
  mov x2, #1
...
__init_l_main___closed__0:
  ...
  .globl _l_main___lam__0
  .align 2
_l_main___lam__0:
  // Function: main._lam_0
  stp x29, x30, [sp, #-16]!
  mov x29, sp
  // save param 0: xx0 → xx19
  mov x19, x0
...
_l_add:
  ...
  .globl _initialize_partial__test
  .align 2
_initialize_partial__test:
