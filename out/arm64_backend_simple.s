...
.Ldec_skip2_fn6423424597098576783:
  ...
  .globl _l_simpleAdd___boxed
  .align 2
_l_simpleAdd___boxed:
  // Function: simpleAdd._boxed
  stp x29, x30, [sp, #-16]
  mov x29, sp
  // save param 0: xx0 → xx19
  mov x19, x0
  ...
  // dec 1
  tst x19, #1
  b.ne .Ldec_skip0_fn2320457647865119099
  ldr x8, [x19]
  sub x8, x8, #1
  str x8, [x19]
.Ldec_skip0_fn2320457647865119099:
  // unbox
  lsr x26, x20, #1
  // dec 1
  tst x20, #1
  b.ne .Ldec_skip1_fn2320457647865119099
  ldr x8, [x20]
  sub x8, x8, #1
  str x8, [x20]
.Ldec_skip1_fn2320457647865119099:
  // call simpleAdd with 2 args
  mov x0, x27
  mov x1, x26
  bl _l_simpleAdd
  mov x25, x0
...
_l_simpleAdd:
  ...
  .globl _initialize_tests_lean_run_arm64__backend__simple
  .align 2
_initialize_tests_lean_run_arm64__backend__simple:
