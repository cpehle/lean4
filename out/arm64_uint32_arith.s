...
.Lcase_ctor1_fn771961157887135399:
  ...
  ldr x21, [x21, _l_main___closed__5@PAGEOFF]
  // call IO.println._at_.main.spec_0 with 2 args
  mov x0, x21
  mov x1, x23
  bl _l_IO_println___at___main_spec__0
...
.Lcase_ctor4_fn771961157887135399:
  ...
  adrp x11, _l_main___closed__8@PAGE
  ldr x11, [x11, _l_main___closed__8@PAGEOFF]
  // call IO.println._at_.main.spec_0 with 2 args
  mov x0, x11
  mov x1, x13
  bl _l_IO_println___at___main_spec__0
...
__init_l_main___closed__7:
  ...
  stp x29, x30, [sp, #-16]!
  mov x29, sp
  movz x27, #22088, lsl #0
  movk x27, #4372, lsl #16
...
__init_l_main___closed__4:
  ...
  stp x29, x30, [sp, #-16]!
  mov x29, sp
  movz x27, #21880, lsl #0
  movk x27, #56798, lsl #16
  // call Nat.reprFast with 1 args
  mov x0, x27
  bl _l_Nat_reprFast
  mov x26, x0
...
_l_IO_print___at___IO_println___at___main_spec__0_spec__0:
  ...
  .globl _initialize_tests_compiler_arm64__uint32__arith
  .align 2
_initialize_tests_compiler_arm64__uint32__arith:
