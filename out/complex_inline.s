...
_l_main___redArg:
  ...
  ldr x8, [x22]
  cmp x8, #0
  b.eq .Lcase1_fn5671910544442644658
  cmp x8, #1
  b.eq .Lcase2_fn5671910544442644658
.Lcase1_fn5671910544442644658:
.Lcase_alt3_fn5671910544442644658:
  // proj field 1
  ldr x23, [x22, #16]
  // inc 1
  mov x0, x23
  ...
  ldr x8, [x12]
  cmp x8, #0
  b.eq .Lcase5_fn5671910544442644658
  cmp x8, #1
  b.eq .Lcase6_fn5671910544442644658
.Lcase5_fn5671910544442644658:
.Lcase_alt7_fn5671910544442644658:
  // proj field 1
  ldr x13, [x12, #16]
  // inc 1
  mov x0, x13
  ...
  ldr x8, [x9]
  cmp x8, #0
  b.eq .Lcase9_fn5671910544442644658
  cmp x8, #1
  b.eq .Lcase10_fn5671910544442644658
.Lcase9_fn5671910544442644658:
.Lcase_alt11_fn5671910544442644658:
  // proj field 1
  ldr x8, [x9, #16]
  ...
  ldr x8, [x8]
  cmp x8, #0
  b.eq .Lcase13_fn5671910544442644658
  cmp x8, #1
  b.eq .Lcase14_fn5671910544442644658
.Lcase13_fn5671910544442644658:
.Lcase_alt15_fn5671910544442644658:
  // load spilled vreg32 from stack slot 3
  ldr x8, [sp, #24]
  // proj field 1
  ldr x8, [x8, #16]
  ...
  ldp x29, x30, [sp], #16
  ret
  b .Lcase_end12_fn5671910544442644658
.Lcase14_fn5671910544442644658:
.Lcase_alt16_fn5671910544442644658:
  // return
  // load spilled vreg32 from stack slot 3
  ldr x8, [sp, #24]
  mov x0, x8
  ...
  ret
  b .Lcase_end12_fn5671910544442644658
.Lcase_end12_fn5671910544442644658:
  b .Lcase_end8_fn5671910544442644658
.Lcase10_fn5671910544442644658:
.Lcase_alt17_fn5671910544442644658:
  // return
  mov x0, x9
  add sp, sp, #112
  ldp x29, x30, [sp], #16
  ret
  b .Lcase_end8_fn5671910544442644658
.Lcase_end8_fn5671910544442644658:
  b .Lcase_end4_fn5671910544442644658
.Lcase6_fn5671910544442644658:
.Lcase_alt18_fn5671910544442644658:
  // return
  mov x0, x12
  add sp, sp, #112
  ldp x29, x30, [sp], #16
  ret
  b .Lcase_end4_fn5671910544442644658
.Lcase_end4_fn5671910544442644658:
  b .Lcase_end0_fn5671910544442644658
.Lcase2_fn5671910544442644658:
.Lcase_alt19_fn5671910544442644658:
  // return
  mov x0, x22
  add sp, sp, #112
  ldp x29, x30, [sp], #16
...
_l_List_foldl___at___main_spec__2:
  ...
  ldr x8, [x20]
  cmp x8, #0
  b.eq .Lcase1_fn7523885109454192454
  cmp x8, #1
  b.eq .Lcase2_fn7523885109454192454
.Lcase1_fn7523885109454192454:
.Lcase_alt3_fn7523885109454192454:
  // return
  mov x0, x19
  ldp x29, x30, [sp], #16
  ret
  b .Lcase_end0_fn7523885109454192454
.Lcase2_fn7523885109454192454:
.Lcase_alt4_fn7523885109454192454:
  // proj field 0
  ldr x27, [x20, #8]
  // proj field 1
  ldr x26, [x20, #16]
