...
; %bb.45:
	...
	.cfi_endproc
                                        ; -- End function
	.section	__TEXT,__literal8,8byte_literals
	.p2align	3, 0x0                          ; -- Begin function initialize_tests_compiler_closure__bug1
lCPI8_0:
	.long	1                               ; 0x1
	.long	131096                          ; 0x20018
	.section	__TEXT,__text,regular,pure_instructions
	.globl	_initialize_tests_compiler_closure__bug1
	.p2align	2
_initialize_tests_compiler_closure__bug1: ; @initialize_tests_compiler_closure__bug1
	.cfi_startproc
; %bb.0:
	stp	x29, x30, [sp, #-16]!           ; 16-byte Folded Spill
	mov	x29, sp
...
; %bb.0:
	...
	mov	w0, #1                          ; =0x1
	bl	_initialize_tests_compiler_closure__bug1
	mov	x19, x0
	mov	w0, #1                          ; =0x1
	bl	_lean_set_panic_messages
