...
_lean_main:
  ...
  // call IO.println._at_._private.Lean.Language.Basic.0.Lean.Language.reportMessages.spec_3 with 2 args
  mov x0, x27
  mov x1, x19
...
__init_l_testBox___closed__3:
  ...
  // call Lean.Name.mkStr1 with 1 args
  mov x0, x27
...
__init_l_testLit___closed__5:
  ...
  stp x27, x28, [sp, #-16]!
  mov x27, #1
  // call Array.mkEmpty with 2 args
  mov x0, #0
  mov x1, x27
...
__init_l_testCase___closed__5:
  ...
  // call Lean.Name.mkStr2 with 2 args
  mov x0, x26
  mov x1, x27
...
_l_emitAsm:
  ...
  mov x20, x1
  mov x27, #0
  // call Lean.mkEmptyEnvironment with 2 args
  mov x0, x27
  mov x1, x20
  bl _l_Lean_mkEmptyEnvironment
  mov x25, x0
  // case
  ldr x8, [x25]
  cmp x8, #0
...
.Lcase_ctor4_fn3001846037551631654:
  // proj field 0
  ldr x22, [x25, #8]
  // call Lean.Compiler.Backend.EmitARM64.emitDecl with 2 args
  mov x0, x22
  mov x1, x19
