...
_l_f___lam__0___boxed:
  ...
  // Boxed function: loading 18 args from array in x0
  // load arg 0: [x0, #0] → x19
  ldr x19, [x0]
  // load arg 1: [x0, #8] → x20
  ldr x20, [x0, #8]
  // load arg 2: [x0, #16] → x21
  ldr x21, [x0, #16]
  // load arg 3: [x0, #24] → x22
  ldr x22, [x0, #24]
  // load arg 4: [x0, #32] → x23
  ldr x23, [x0, #32]
  // load arg 5: [x0, #40] → x24
  ldr x24, [x0, #40]
  // load arg 6: [x0, #48] → x25
  ldr x25, [x0, #48]
  // load arg 7: [x0, #56] → x26
  ldr x26, [x0, #56]
  // load arg 8: [x0, #64] → x27
  ldr x27, [x0, #64]
  // load arg 9: [x0, #72] → x28
  ldr x28, [x0, #72]
  // spill arg 10: [x0, #80] → [sp, #0]
  ldr x8, [x0, #80]
  str x8, [sp]
  // spill arg 11: [x0, #88] → [sp, #8]
  ldr x8, [x0, #88]
  str x8, [sp, #8]
  // spill arg 12: [x0, #96] → [sp, #16]
  ldr x8, [x0, #96]
  str x8, [sp, #16]
  // spill arg 13: [x0, #104] → [sp, #24]
  ldr x8, [x0, #104]
  str x8, [sp, #24]
  // spill arg 14: [x0, #112] → [sp, #32]
  ldr x8, [x0, #112]
  str x8, [sp, #32]
  // spill arg 15: [x0, #120] → [sp, #40]
  ldr x8, [x0, #120]
  str x8, [sp, #40]
  // spill arg 16: [x0, #128] → [sp, #48]
  ldr x8, [x0, #128]
  str x8, [sp, #48]
  // spill arg 17: [x0, #136] → [sp, #56]
  ldr x8, [x0, #136]
  str x8, [sp, #56]
  // call f._lam_0 with 18 runtime args
  mov x0, x19
  mov x1, x20
  mov x2, x21
  mov x3, x22
  ...
  ldr x8, [sp]
  str x8, [sp, #16]
  // load spilled vreg31 from stack slot 1
  ldr x8, [sp, #8]
  str x8, [sp, #24]
  // load spilled vreg32 from stack slot 2
  ldr x8, [sp, #16]
  str x8, [sp, #32]
  // load spilled vreg33 from stack slot 3
  ldr x8, [sp, #24]
  str x8, [sp, #40]
  // load spilled vreg34 from stack slot 4
  ldr x8, [sp, #32]
  str x8, [sp, #48]
  // load spilled vreg35 from stack slot 5
  ldr x8, [sp, #40]
  str x8, [sp, #56]
  // load spilled vreg36 from stack slot 6
  ldr x8, [sp, #48]
  str x8, [sp, #64]
  // load spilled vreg37 from stack slot 7
  ldr x8, [sp, #56]
  str x8, [sp, #72]
  bl _l_f___lam__0
  add sp, sp, #80
  ...
  str x8, [sp, #64]
  // return
  // load spilled vreg38 from stack slot 8
  ldr x8, [sp, #64]
  mov x0, x8
  add sp, sp, #80
  ldp x27, x28, [sp], #16
...
_l_f:
  ...
  stp x27, x28, [sp, #-16]!
  sub sp, sp, #224
  // Stack frame: 224 bytes (28 spilled vars)
.Lfn_start_f:
  mov x19, x0
  movz x0, #1, lsl #0
  ...
  // call Nat.add with 2 runtime args
  mov x0, x19
  // load spilled vreg47 from stack slot 0
  ldr x8, [sp]
  mov x1, x8
  bl _lean_nat_add
  mov x8, x0
  ...
  // call Nat.add with 2 runtime args
  mov x0, x19
  // load spilled vreg49 from stack slot 2
  ldr x8, [sp, #16]
  mov x1, x8
  bl _lean_nat_add
  mov x8, x0
  ...
  // call Nat.add with 2 runtime args
  mov x0, x19
  // load spilled vreg51 from stack slot 4
  ldr x8, [sp, #32]
  mov x1, x8
  bl _lean_nat_add
  mov x8, x0
  ...
  str x8, [sp, #200]
  // partial application f._lam_0._boxed with 17 args
  ...
  bl _lean_closure_set
  mov x1, #5
  // load spilled vreg62 from stack slot 15
  ldr x8, [sp, #120]
  mov x2, x8
  bl _lean_closure_set
  mov x1, #6
  ...
  bl _lean_closure_set
  mov x1, #10
  // load spilled vreg52 from stack slot 5
  ldr x8, [sp, #40]
  mov x2, x8
  bl _lean_closure_set
  mov x1, #11
  // load spilled vreg50 from stack slot 3
  ldr x8, [sp, #24]
  mov x2, x8
  bl _lean_closure_set
  mov x1, #12
  // load spilled vreg48 from stack slot 1
  ldr x8, [sp, #8]
  mov x2, x8
  bl _lean_closure_set
  mov x1, #13
...
_l_f___lam__0:
  ...
  stp x27, x28, [sp, #-16]!
  sub sp, sp, #240
  // Stack frame: 240 bytes (29 spilled vars)
  // load stack param 8: [x29, #16] → x27
  ldr x27, [x29, #16]
  // load stack param 9: [x29, #24] → x28
  ldr x28, [x29, #24]
  // spill stack param 10: [x29, #32] → [sp, #0]
  ldr x8, [x29, #32]
  str x8, [sp]
  // spill stack param 11: [x29, #40] → [sp, #8]
  ldr x8, [x29, #40]
  str x8, [sp, #8]
  // spill stack param 12: [x29, #48] → [sp, #16]
  ldr x8, [x29, #48]
  str x8, [sp, #16]
  // spill stack param 13: [x29, #56] → [sp, #24]
  ldr x8, [x29, #56]
  str x8, [sp, #24]
  // spill stack param 14: [x29, #64] → [sp, #32]
  ldr x8, [x29, #64]
  str x8, [sp, #32]
  // spill stack param 15: [x29, #72] → [sp, #40]
  ldr x8, [x29, #72]
  str x8, [sp, #40]
  // spill stack param 16: [x29, #80] → [sp, #48]
  ldr x8, [x29, #80]
  str x8, [sp, #48]
  // spill stack param 17: [x29, #88] → [sp, #56]
  ldr x8, [x29, #88]
  str x8, [sp, #56]
.Lfn_start_f._lam_0:
  mov x19, x0
  ...
  mov x2, x8
  bl _lean_ctor_set
  // load spilled vreg58 from stack slot 9
  ldr x8, [sp, #72]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x8
  bl _lean_ctor_set
  // load spilled vreg59 from stack slot 10
  ldr x8, [sp, #80]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x19
  bl _lean_ctor_set
  // load spilled vreg60 from stack slot 11
  ldr x8, [sp, #88]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x20
  bl _lean_ctor_set
  // load spilled vreg61 from stack slot 12
  ldr x8, [sp, #96]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x21
  bl _lean_ctor_set
  // load spilled vreg62 from stack slot 13
  ldr x8, [sp, #104]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x22
  bl _lean_ctor_set
  // load spilled vreg63 from stack slot 14
  ldr x8, [sp, #112]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x23
  bl _lean_ctor_set
  // load spilled vreg64 from stack slot 15
  ldr x8, [sp, #120]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x24
  bl _lean_ctor_set
  // load spilled vreg65 from stack slot 16
  ldr x8, [sp, #128]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x25
  bl _lean_ctor_set
  // load spilled vreg66 from stack slot 17
  ldr x8, [sp, #136]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x26
  bl _lean_ctor_set
  // load spilled vreg67 from stack slot 18
  ldr x8, [sp, #144]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x27
  bl _lean_ctor_set
  // load spilled vreg68 from stack slot 19
  ldr x8, [sp, #152]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x28
  bl _lean_ctor_set
  // load spilled vreg69 from stack slot 20
  ldr x8, [sp, #160]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  bl _lean_alloc_ctor
  mov x19, x0
  // load spilled vreg50 from stack slot 0
  ldr x8, [sp]
  mov x0, x19
  mov x1, #0
  mov x2, x8
  bl _lean_ctor_set
  // load spilled vreg70 from stack slot 21
  ldr x8, [sp, #168]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x8
  bl _lean_ctor_set
  // load spilled vreg71 from stack slot 22
  ldr x8, [sp, #176]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x8
  bl _lean_ctor_set
  // load spilled vreg72 from stack slot 23
  ldr x8, [sp, #184]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x8
  bl _lean_ctor_set
  // load spilled vreg73 from stack slot 24
  ldr x8, [sp, #192]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x8
  bl _lean_ctor_set
  // load spilled vreg74 from stack slot 25
  ldr x8, [sp, #200]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x8
  bl _lean_ctor_set
  // load spilled vreg75 from stack slot 26
  ldr x8, [sp, #208]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  mov x2, x8
  bl _lean_ctor_set
  // load spilled vreg76 from stack slot 27
  ldr x8, [sp, #216]
  mov x0, x19
  mov x1, #1
  mov x2, x8
  ...
  // load spilled vreg77 from stack slot 28
  ldr x8, [sp, #224]
  mov x0, x8
  ...
  str x8, [sp, #64]
  // return
  // load spilled vreg78 from stack slot 8
  ldr x8, [sp, #64]
  mov x0, x8
  add sp, sp, #240
  ldp x27, x28, [sp], #16
