...
__init_l_main___closed__7:
  ...
  stp x25, x26, [sp, #-16]!
  stp x27, x28, [sp, #-16]!
  movz x27, #44177, lsl #0
  movk x27, #8744, lsl #16
...
__init_l_main___closed__4:
  ...
  stp x25, x26, [sp, #-16]!
  stp x27, x28, [sp, #-16]!
  movz x27, #43761, lsl #0
  movk x27, #48060, lsl #16
  movk x27, #1, lsl #32
  // call Nat.reprFast with 1 args
  mov x0, x27
  bl _l_Nat_reprFast
...
_l_IO_print___at___IO_println___at___main_spec__0_spec__0:
  ...
  .globl _initialize_arm64__uint32__arith
  .align 2
_initialize_arm64__uint32__arith:
